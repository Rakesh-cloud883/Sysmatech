...
public class Tc_Settings_DepartMentsUpdate_016 extends BaseClass{

	
	@Test
	public void DepartmentUpdate() throws InterruptedException {
		  LoginPage lp=new LoginPage(driver);  
	  		...
	  		page.SetUpdateBtn();
	  		page.SetDepartmentName("AutomationDepartment");
