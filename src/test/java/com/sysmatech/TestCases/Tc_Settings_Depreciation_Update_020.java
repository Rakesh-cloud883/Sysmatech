...
public class Tc_Settings_Depreciation_Update_020 extends BaseClass {
	@Test
	public void DepreciationUpdate() throws InterruptedException {
		  LoginPage lp=new LoginPage(driver);  
	  		...
	  		page.SetUpdateBtn();
	  		page.SetDepreciationName("AutomationDepreciation");
