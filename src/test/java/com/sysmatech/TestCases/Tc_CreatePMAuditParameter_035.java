...
public class Tc_CreatePMAuditParameter_035 extends BaseClass{
	@Test(priority = 1)
	public void paraMasterText1() throws InterruptedException {
		  LoginPage lp=new LoginPage(driver);  
	  		...
	  		page.SetPrevM();
	  		page.SetCreateBtn();
	  		page.SetCollectionName("Test 1-Daily");
	  		page.SetSelectModel();
	  		page.SetStatus();                                                   
